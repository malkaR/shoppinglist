...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'list_list', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='Shopping List', max_length=20)),
        ...
        # Adding field 'ListItem.list'
        db.add_column(u'list_listitem', 'list',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['list.List']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ListItem.list'
        db.delete_column(u'list_listitem', 'list_id')
    ...
    models = {
        ...
        u'list.list': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Shopping List'", 'max_length': '20'}),
